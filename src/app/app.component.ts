  ...
  template: `
    ...
    <section class="finalists" *ngIf="bs.state === STATE.FINISHED">
      <div class="panel first-place" *ngIf="bs.bracket?.winner">
        ...
        <h2 class="name">{{bs.bracket?.winner}}</h2>
      </div>
      <div class="panel runner-up" *ngIf="bs.bracket?.loser">
        ...
        <h3 class="name">{{bs.bracket?.loser}}</h3>
      </div>
    </section>
    <div class="container">
      <section class="setup" *ngIf="bs.state === STATE.SETUP">
        ...
        <div class="active-players" *ngIf="bs.players.length">
          ...
          <div class="player-list">
            <button class="player-button button" *ngFor="let player of bs.players; let i = index" (click)="removePlayer(i)">
...
export class AppComponent {
  ...
  public addPlayer(): void {
    this.bs.addPlayer(this.addPlayerValue);
    this.addPlayerValue = '';
  }

  public removePlayer(index: number): string[] {
    return this.bs.removePlayer(index);
  }
